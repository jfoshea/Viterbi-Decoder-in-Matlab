function [sel_out, metric_out]  =bACS_322(t,L,hd_in1,hd_in2,hd_in3,hd_in4,acc_in1,acc_in2,acc_in3,acc_in4)
%=============================================================================
% function [sel_out, metric_out]
%    =bACS_322(t,L,hd_in1,hd_in2,hd_in3,hd_in4,acc_in1,acc_in2,acc_in3,acc_in4)
%
