...
%   State 0 ACS
%======================
[sel_out0, metric_out0]=bACS_213(HD(1,1),HD(1,9),A_copy(1,(st0+1)),A_copy(1,(st4+1)));
...
%   State 1 ACS
%======================
[sel_out1, metric_out1]=bACS_213(HD(1,2),HD(1,10),A_copy(1,(st0+1)),A_copy(1,(st4+1)));
...
[sel_out2,metric_out2]=bACS_213(HD(1,3),HD(1,11),A_copy(1,(st1+1)),A_copy(1,(st5+1)));
...
[sel_out3,metric_out3]=bACS_213(HD(1,4),HD(1,12),A_copy(1,(st1+1)),A_copy(1,(st5+1)));
...
[sel_out4,metric_out4]=bACS_213(HD(1,5),HD(1,13),A_copy(1,(st2+1)),A_copy(1,(st6+1)));
...
[sel_out5, metric_out5]=bACS_213(HD(1,6),HD(1,14),A_copy(1,(st2+1)),A_copy(1,(st6+1)));
...
[sel_out6, metric_out6]=bACS_213(HD(1,7),HD(1,15),A_copy(1,(st3+1)),A_copy(1,(st7+1)));
...
[sel_out7, metric_out7]=bACS_213(HD(1,8),HD(1,16),A_copy(1,(st3+1)),A_copy(1,(st7+1)));
