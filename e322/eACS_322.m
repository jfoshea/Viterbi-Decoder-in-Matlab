function [sel_out, metric_out]  =eACS_322(HD_in1,HD_in2,HD_in3,HD_in4,A_in1,A_in2,A_in3,A_in4)
%====================================================================
% function [sel_out, metric_out]
%    =eACS_322(HD_in1,HD_in2,HD_in3,HD_in4,A_in1,A_in2,A_in3,A_in4)
%	Add-Compare-Select Block for efficient (3,2,2) decoder
%
